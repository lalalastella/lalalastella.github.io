...
- Hero introduction: **Building reliable, user-facing AI systems across LLM agents, retrieval, evaluation, and full-stack products.**
- Browser title: **Stella Jiang | AI & Software Engineer**

## Navigation

1. Experience — Engineering, product, and industry experience
2. Projects — PantryAgent · Intent2Escrow · C&S MovieStore
...
> AI products and systems designed around reliability, inspectability, and real user workflows.
...
- Label: Archive
- Meta: Search Systems Project
- Summary: A disk-based search engine implementing scalable indexing and ranked retrieval over document collections.
