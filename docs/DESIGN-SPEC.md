...
- Leadership & Community appears as a compact three-item list with verified organization marks below the About overview, without dates, activity descriptions, or another top-level navigation module.
